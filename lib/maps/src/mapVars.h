...
static const String mapVectorFolder PROGMEM = "/VECTMAP/";        // Vector Map Files Folder
static const char *mapRenderFolder PROGMEM = "/MAP/%d/%d/%d.png"; // Render Maps file folder
