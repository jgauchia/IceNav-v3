...
static const char* statusLine2 = "Free mem:%dK %d%%";          /**< Format string for free memory in KB and percentage */
static const char* statusLine3 = "PSRAM: %d - Used PSRAM: %d"; /**< Format string for PSRAM total and used */
static const char* statusLine4 = "Firmware v.%s rev.%s";       /**< Format string for firmware version and revision */
static const char* statusLine5 = "ENV: %s";                    /**< Format string for environment information */
