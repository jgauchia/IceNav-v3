 ...
 *
 * @details Display/touch/I2C/SD/power-button pins verified against the
 *          Waveshare BSP and schematic (esp32_p4_wifi6_touch_lcd_35). GPS
 *          UART and battery (AXP2101 PMIC, I2C) still TODO.
 */
